        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "friendlyname",
                    models.CharField(
                        max_length=30, verbose_name="Friendly name of the Dataset"
                    ),
                ),
                (
                    "featurenames",
                    models.JSONField(
                        default=list,
                        verbose_name="Friendly feature names as a json-list",
                    ),
                ),
                (
                    "filepath",
                    models.FileField(
                        upload_to="dataset/",
                        verbose_name="Dataset as csv. First column must be target",
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="app.dataset",
                        verbose_name="Dataset, model was calculated for",
                    ),
                ),
            ],
        ),
